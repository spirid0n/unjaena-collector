...
class ConsentDialog(QDialog):
    ...
    def _get_consent_html_en(self) -> str:
        ...
        <p>Contact: admin@unjaena.ai.com | Company: unJaena AI | Representative: Sangjun Park</p>
    ...
    def _get_consent_html_ko(self) -> str:
        ...
        <p>권리 행사: admin@unjaena.ai.com | 회사: unJaena AI | 대표자: 박상준</p>
    ...
    def _get_consent_html_ja(self) -> str:
        ...
        <p>お問い合わせ：admin@unjaena.ai.com | 会社：unJaena AI | 代表者：朴相俊</p>
    ...
    def _get_consent_html_zh(self) -> str:
        ...
        <p>联系方式：admin@unjaena.ai.com | 公司：unJaena AI | 代表人：朴相俊</p>
